...
singularity exec --bind /project2 --bind /dali /project2/lgrandi/xenonnt/singularity-images/xenonnt-development.simg /home/yingfan/waveform_caching_service/service.py